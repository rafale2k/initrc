# Generated by Powerlevel10k configuration wizard on 2026-02-14 at 01:14 JST.
...
# 2 lines, solid, full frame, blue-ornaments, sparse, many icons, fluent,
...
function prompt_my_docker_status() {
  ...
  if (( count > 0 )); then
    p10k segment -f 40 -i '🐳' -t "$count"
  fi
}
typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS+=(my_docker_status)
